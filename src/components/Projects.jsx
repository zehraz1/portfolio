  ...
  return (
    <>
      <div id="projects" className="pt-20">
        <h1 className="text-white text-4xl  md:text-5xl lg:text-8xl md:pl-20 xl:pl-60 pb-5 text-center md:text-left  ">Projects</h1>

        <div className="container mx-auto px-4 overflow-x-auto flex space-x-4 scroll-smooth overflow-scroll hide-scrollbar">
          {/* Project 1 */}
