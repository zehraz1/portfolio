...
const HomeMain = () => {
  return (
    <>   
      <div id='home' className="flex flex-col justify-center items-center pt-5 max-h-screen md:pt-28 md:flex-row-reverse md:justify-between md:items-center w-[90%] md:w-[85%] lg:w-[80%] mx-auto ">
        ...
        <div className="text-center md:text-left md:w-1/2 lg:w-full ">
          ...
          <div className="mt-6">
            <a href="/path-to-your-cv.pdf" download>
              <button className="bg-white text-black font-semibold xl:text-xl rounded-full px-8 py-3">
                Download CV
              </button>
            </a>
          </div>
